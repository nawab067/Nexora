...
// ─── Props contract — matches SettingsPage container exactly ───────────────────
                    ...
                    <div className="flex items-center justify-between gap-2">
                        ...
                        {account?.email && (
                            <div className="flex items-center gap-1.5">
                                <span className="inline-flex items-center gap-1 text-[11px] font-medium text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200 dark:border-emerald-500/30 rounded-full pl-2 pr-2 py-0.5 max-w-[180px]">
...
export default function Settings({
    ...
    return (
        <>
            ...
            <header className="sticky top-0 z-10 h-14 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 flex items-center px-4 gap-3 shrink-0">
            ...
            {/* ── Page body ── */}
            <div className="p-6 bg-slate-50 dark:bg-slate-950 min-h-[calc(100vh-3.5rem)]">
                        ...
                        <div className="flex-1 min-w-0 space-y-5">
                            {activeSection === "appearance" && (
                                <>
                                    ...
                                    {/* Quick toggle row */}
                                    <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm px-5 py-4 flex items-center justify-between">
                                        ...
                                        <Button
                                            ...
                                            className="h-9 text-sm gap-1.5 border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 dark:hover:bg-slate-800 rounded-lg"
                                            disabled={!mounted}
                                        >
                                            {mounted && theme === "dark" ? (
                                                <>
