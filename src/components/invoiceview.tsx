...
export default function InvoiceListView({
  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-10 h-14 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/80 border-b border-slate-200 flex items-center px-3 sm:px-4 gap-2 sm:gap-3 shrink-0">
        <SidebarTrigger className="text-slate-500 hover:text-slate-900 shrink-0" />
        ...
        <div className="hidden sm:flex items-center gap-2 flex-1 max-w-sm min-w-0">
          ...
          <input
            ...
            className="w-full text-sm text-slate-900 placeholder:text-slate-400 bg-transparent outline-none min-w-0"
          />
        </div>
      </header>

      <div className="p-3 sm:p-5 lg:p-6 space-y-4 sm:space-y-5 bg-slate-50 min-h-[calc(100vh-3.5rem)]">
        {/* Heading */}
