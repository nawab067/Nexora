...
export default function CustomerInfoContainer() {
    ...
    const [aiEmail, setAiEmail] = useState<AIEmailDialogState>(DEFAULT_EMAIL_STATE);
    ...
    useEffect(() => {
        ...
        const fetchCustomers = async () => {
            setLoading(true);
            try {
                const res = await axios.get(`${baseurl}/lead/user/${userid}`, {
   ...
   const handleSendEmail = async () => {
    ...
    const handleCloseEmailDialog = () =>
        setAiEmail(DEFAULT_EMAIL_STATE);
